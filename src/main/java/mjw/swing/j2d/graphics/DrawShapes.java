...
public class DrawShapes extends JComponent
{
    ...
    /**
     * Generates a star Shape from the given location, radii, and points parameters. The Shape is created by
     * constructing a GeneralPath that moves between the inner and outer rings.
     */
    ...
    /**
     * Generates a donut shape from the given location and radii by subtracting an inner circular Area from an outer
     * one.
     */
    ...
    /**
     * This class processes mouse clicks and generates stars and donuts, alternately, in the click location. The new
     * shape is added to the List of current shapes, then the scene is repainted.
     */
    ...
    public static void main(String[] args) {
        Runnable doCreateAndShowGUI = DrawShapes::createAndShowGUI;
