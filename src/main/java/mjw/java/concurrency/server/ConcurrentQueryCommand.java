...
/**
 * Class that implements the concurrent version of the Query Command. The format of this query is:
 * q;codCountry;codIndicator;year where codCountry is the code of the country, codIndicator is the code of the indicator
 * and the year is an optional parameter with the year you want to query
 *
 * @author author
 */
