 ...
 * @author Jiawei Mao
 * @version 0.1.0
 * @since 08 Oct 2024, 1:42 PM
 */
public class DataFrameTest {

    @Test
    public void foldByRowArray() {
    ...
    @Test
    public void foldByRowStream_Partial() {
        DataFrame df = DataFrame.foldByRow("a", "b")
    ...
    @Test
    public void foldByRowIterable_Partial() {
        DataFrame df = DataFrame.foldByRow("a", "b")
    ...
    @Test
    public void foldByRowIntStream() {
        DataFrame df = DataFrame.foldByRow("a", "b")
    ...
    @Test
    public void foldByRowIntStream_Partial() {
        DataFrame df = DataFrame.foldByRow("a", "b")
    ...
    @Test
    public void foldByRowLongStream() {
        DataFrame df = DataFrame.foldByRow("a", "b")
    ...
    @Test
    public void foldByRowLongStream_Partial() {
        DataFrame df = DataFrame.foldByRow("a", "b")
    ...
    @Test
    public void foldByRowDoubleStream() {
        DataFrame df = DataFrame.foldByRow("a", "b")
