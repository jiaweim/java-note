...
public class ScaleTest extends JComponent
{
    ...
    /**
     * Paints the test image that will be downscaled and timed by the various scaling methods. A different image is
     * rendered into each of the four quadrants of this image: RGB stripes, a picture, vector art, and a black and white
     * grid.
     */
    ...
    /**
     * Progressive Bilinear approach: this method gets each scaled version from the getOptimalScalingImage method and
    ...
    /**
     * This approach uses either the getScaledInstance() approach to get each new size or it scales on the fly using
     * drawImage().
     */
    ...
    /**
     * Scale the image to several smaller sizes using each of the approaches and time each series of operations. The
     * times are output into the application window for each row that they represent.
     */
