...
`Region` 的绘制区域分为多个部分，根据其属性设置，`Region` 可能绘制到其 layout-bound 之外：
...
<img src="images/Pasted%20image%2020230707093712.png" style="zoom:67%;" />
...
![](images/Pasted%20image%2020230707103849.png)
