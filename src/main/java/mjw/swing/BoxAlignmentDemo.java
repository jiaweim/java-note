...
public class BoxAlignmentDemo extends JPanel
{
    ...
    {
        JButton button1 = new JButton("A JButton", createImageIcon("middle.gif"));
        button1.setVerticalTextPosition(AbstractButton.BOTTOM);
        button1.setHorizontalTextPosition(AbstractButton.CENTER);

        JButton button2 = new JButton("Another JButton",
                createImageIcon("geek-cght.gif"));
    ...
    {
        java.net.URL imgURL = BoxAlignmentDemo.class.getClassLoader().getResource(path);
        if (imgURL != null) {
